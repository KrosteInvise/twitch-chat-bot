...
namespace NaughtyAttributes.Editor
{
    ...
    public class InspectorEditor : UnityEditor.Editor
    {
        ...
        private List<string> excludeFieldsInternal;
        private List<string> includeFieldsInternal;

        private Dictionary<string, SerializedProperty> serializedPropertiesByFieldName;

        private bool useDefaultInspector;

        public static bool drawScript = true;
        public static List<string> excludeFields;
        public static List<string> includeFields;
        
        private void OnEnable()
        {
            includeFieldsInternal = includeFields;
            excludeFieldsInternal = excludeFields;
            ...
            if (drawScript &&
                (excludeFields == null && includeFields == null) &&
                this.fields.All(f => f.GetCustomAttributes(typeof(NaughtyAttribute), true).Length == 0))
            {
        ...
        { 
            ...
            else
            {
                ...
                if (this.script != null && drawScript)
                {
                    GUI.enabled = false;
