...
- 💬 **Real‑time message parsing** — listens to chat messages and extracts commands  
- 🎮 **Unity event triggers** — chat messages can influence objects, animations, or gameplay  
